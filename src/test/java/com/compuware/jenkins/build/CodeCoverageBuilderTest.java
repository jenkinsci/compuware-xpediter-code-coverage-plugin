...
import com.compuware.jenkins.build.CodeCoverageBuilder.CodeCoverageBuilderDescriptor;
...
public class CodeCoverageBuilderTest
{
	...
	private TestScanner m_testScanner = new TestScanner(null);
	...
	public void descriptorValuesTest()
	{
		...
		CodeCoverageBuilderDescriptor descriptor = (CodeCoverageBuilderDescriptor) builder.getDescriptor();
